...
export default function HomePage() {
  return (
    <div className="flex flex-col justify-center text-center flex-1 gap-4">
      ...
      <h1 className="text-4xl font-bold">Set reconciliation docs for riblt and ORP</h1>
      <p className="text-fd-muted-foreground max-w-2xl mx-auto">
        Learn the low-level RIBLT engine and the higher-level document reconciliation protocol built on top of it.
      </p>
      <p>
        Open{' '}
